...
SELECT
  ...
  post_tax_meal_allowance_offset_usd + post_tax_roth_usd + post_tax_critical_illness_usd + post_tax_ad_d_usd + post_tax_long_term_disability_usd + post_tax_citi_bike_usd AS calculated_total,
